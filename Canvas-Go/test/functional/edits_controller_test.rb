...
class EditsControllerTest < ActionController::TestCase
  ...
  test "should create edit" do
    assert_difference('Edit.count') do
      post :create, edit: { border: @edit.border, crop: @edit.crop, effects: @edit.effects, fancyedges: @edit.fancyedges, rolledcanvas: @edit.rolledcanvas }
    end
  ...
  test "should update edit" do
    put :update, id: @edit, edit: { border: @edit.border, crop: @edit.crop, effects: @edit.effects, fancyedges: @edit.fancyedges, rolledcanvas: @edit.rolledcanvas }
    assert_redirected_to edit_path(assigns(:edit))
  end
